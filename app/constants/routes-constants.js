...
export const FROZEN_FUNDS = '/frozen-funds';
...
export const LOCKED_ROUTES = [
	...
	RECEIVE, INDEX_ROUTE, FROZEN_FUNDS,
];


export const SIDE_MENU_ROUTES = [WALLET, SEND, MANAGE_ACCOUNTS, HISTORY, SETTINGS, RECEIVE, FROZEN_FUNDS];
