...
import { ENCRYPTED_DB_NAME, SCRYPT_ALGORITHM_PARAMS, ALGORITHM_IV_BYTES_LENGTH } from '../constants/global-constants';
...
class StorageService {
	...
	/**
	 *
	 * @return {{version: number, created_at: string, salt: string, N, r: number, p: number, l: number, IV: string}}
	 */
